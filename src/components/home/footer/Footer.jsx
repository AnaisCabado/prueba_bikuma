        ...
        <section id="footer">
            <article className="footer-info">
                <div className="footer-info__about-us">
                    <img src="/assets/images/logotipo-white.png" alt="logotipo puntodis" loading='lazy' className='footer-logo' />
                ...
                <div className="footer-info__form">
                    <form action="POST">
                        ...
                        <div className="checkbox">
                            <input type="checkbox" /> <p>Acepto la política de privacidad</p>
                        </div>
